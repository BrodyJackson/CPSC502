      ...
      <>
        <Grid className='formElement'>
          <Grid container className={'welcomeHeaderContainer'} justify={'space-around'}>
            <Grid item md className={'welcomeLeftPadding'} style={{textAlign:'start', paddingLeft: '10%'}}>
            ...
            <Grid item md>
              <Bacteria1 className={'welcomeImg1'} style={{ width: '100%', maxHeight: '35vh'}}></Bacteria1>
            </Grid>
          </Grid>
          <Grid container style={{marginTop: '20vh'}} className={'flexController'}>
            <Grid item md>
              <Bacteria2 className={'welcomeImg2'} style={{width: '100%', maxHeight: '35vh'}}></Bacteria2>
            </Grid>
            <Grid item md>
              <Typography className={'welcomeSubHeading welcomeLeftPadding'} variant='h4' style={{color:'#74c7c5'}}>Why do I need this?</Typography>
              <Typography className={'welcomeLeftPadding'} variant='h6' style={{ marginTop:'3vh', paddingLeft:'10%', fontWeight:300, textAlign:'start' }}>
